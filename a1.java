/* Symbol Table class */
/* Fields: index, symbol name, address */
class symtab {
    int index;
    String name;
    int addr;
...
/* Literal Table class */
/* Fields: index, literal name, address */
class littab {
    int index;
    String name;
    int addr;
...
public class a1 {
    ...
    static int check(String m) {
        if (m.equals("MOVER") || m.equals("ADD") || m.equals("SUB") || m.equals("MUL")) {
            return 1;
        } else if (m.equals("DS")) {
            return 2;
        } else if (m.equals("DC")) {
